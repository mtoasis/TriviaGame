...
function generate_question(){ 
	...
	var question_text=[];
	// var answers={incorrect_array:[],correct_array:[]};
	var answers_array=[];
	...
	for (var i=0; i<len; i++){
		...
		// answers.incorrect_array[i]=response.results[i].incorrect_answers;
		// answers.correct_array[i]=response.results[i].correct_answer;
		answers_array[i]=response.results[i].incorrect_answers+','+response.results[i].correct_answer;
	}
